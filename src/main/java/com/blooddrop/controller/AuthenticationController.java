...
public ResponseEntity<?> register(@RequestBody RegisterRequest request) {
    ...
    try {
        ...
        e.printStackTrace();
        System.err.println("Registration error: " + e.getMessage()); return ResponseEntity.badRequest().body(e.getMessage());
    } catch (Exception e) {
        e.printStackTrace(); // 👈 ADD THIS
        System.err.println("Registration error: " + e.getMessage()); return ResponseEntity.badRequest().body(e.getMessage()); // 👈 CHANGE THIS
    }
}
